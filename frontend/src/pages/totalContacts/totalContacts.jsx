    ...
    <div className="container-fluid ">
      <div className="row">
        ...
        >
          <div className="text-center pt-3 ">
            ...
            <p className="btn btn-primary">
              <i className="bi bi-person-lines-fill"></i> Total Contacts
            </p>
          </div>
        ...
        <div className="crud shadow-lg col-lg-10 p-3  bg-body rounded">
          <div className="row ">
            <div
              className="col-sm-5  mt-2 mb-4 text-gred"
              style={{ color: "#454545" }}
            >
              <h2>
                <b>Total Contacts</b>
            ...
            <div className="col-sm-2  mt-2 mb-4 text-gred d-flex">
              <div
                className="admin-image full-right"
              ...
              <div className="admin-content">
                <p className="admin-name" style={{ marginLeft: "5px" }}>
                  <span>{user}</span>
                  <br />
                  <span>Admin</span>
                </p>
                    ...
                    <tr key={udata._id}>
                      ...
                      <td>
                        ...
                        <i
                          ...
                          onClick={() => handleDeleteClick(udata._id)}
                        ></i>{" "}
                      </td>
                    </tr>
                  ))}
