    ...
    <>
      ...
      <div className="parent">
        <div className="container1">
          <div>
            <img src={side} id="logo" alt="icon"></img>
          </div>
                        ...
                        <tr className={`${index % 2 === 0 ? "odd" : "even"}`}>
                          <td>
                            <div className="nameContainer">
                              <input
                                ...
                                onChange={(e) => {
                                  changeChecked(contact);
                                }}
                              />
                              <p title={contact.name} className="name1">
                                {contact.name}
                              </p>
                            </div>
                          </td>
                          <td title={contact.designation}>
                            {contact.designation}
                          </td>
                          ...
                          <td>
                            <div className="buttonContainer1">
                              ...
                              <svg
                                onClick={(e) => individualDlt(contact)}
